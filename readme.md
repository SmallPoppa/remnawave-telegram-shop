...
1. Оплата крипто переделана на USD
2. В варианты оплаты добавлен прямой перевод на кошелек, отправка скриншота оплаты админу через бот и ответ (через ответить на сообщение) пользователю от админа

Код написан нейросетями, к использованию не рекомендую :)

Новая переменная в .env

| Variable                 | Description                                                                                                          |
|--------------------------|----------------------------------------------------------------------------------------------------------------------| 
| `USDT_WALLET_ADDRESS`    | Кошелек для прямой оплаты                                                                                            |
